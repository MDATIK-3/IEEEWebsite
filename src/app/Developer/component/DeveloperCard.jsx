...
const DeveloperCard = () => {
  ...
  const DeveloperProfile = ({ dev }) => (
    <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-md hover:shadow-lg transition-shadow p-6">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 space-y-16">
      ...
      <section className="text-center space-y-4">
        ...
        <h3 className="text-xl font-bold text-gray-600 dark:text-green-400 mt-6">Project Lead</h3>
      ...
      <section className="text-center space-y-6">
        <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Meet Our Developers</h3>
