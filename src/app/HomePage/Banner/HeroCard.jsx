...
export default function HeroCard() {
  return (
    <div className="relative z-10">
      ...
      >
        <div className="absolute top-4 right-4 w-24 h-24 bg-gradient-to-br from-green-400/40 to-emerald-500/40 rounded-full blur-xl animate-pulse"></div>

        <div className="absolute bottom-4 left-4 w-20 h-20 bg-gradient-to-br from-blue-400/40 to-indigo-500/40 rounded-full blur-xl animate-pulse"></div>
