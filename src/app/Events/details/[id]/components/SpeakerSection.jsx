            ...
            <div className="space-y-6 sm:space-y-8">
                {event.speakers.map((speaker, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={`flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 ${index !== 0 ? 'pt-6 sm:pt-6 border-t border-gray-100' : ''
                                }`}
                        >
                            ...
                            <div className="flex-1 min-w-0 text-center sm:text-left">
                                ...
                                <p
                                    className={`text-gray-600 leading-relaxed transition-all duration-300 text-sm sm:text-base ${isExpanded ? '' : 'line-clamp-3 sm:line-clamp-2'
                                        }`}
