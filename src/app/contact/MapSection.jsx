...
const MapSection = () => (
    <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-gray-200/50 dark:border-gray-700/50">
        <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Our Location</h2>
        </div>
        <div className="rounded-3xl overflow-hidden shadow-2xl ring-1 ring-gray-200/50 dark:ring-gray-600/50 h-96 lg:h-[500px]">
            <iframe
                ...
                className="w-full h-full hover:brightness-105 transition-all duration-300"
            />
        </div>
    </div>
);
